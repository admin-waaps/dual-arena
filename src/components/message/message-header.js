...
const MessageHeader = ({toggleChat}) => {
  ...
  return (
    ...
    <span className="msg-span flex justify-center items-center  w-[38px] h-[38px]">
      <div className="flex justify-center items-center rounded-full w-[40px] h-[40px] bg-[#23224A] text-black  hover:bg-[#5a4dba]" onClick={()=>toggleChat()}>
    ...
    <span className="flex justify-center items-center  w-[38px] h-[38px]" onClick={()=>{setToggler(!toggler);} }>
      ...
      {toggler && <div className='w-auto h-auto absolute shadow-xl top-16'>
      <Rooms rooms={rooms}/>
    </div>}
