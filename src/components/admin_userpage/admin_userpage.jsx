...
const AdminUserPage = () => {
    ...
    return (
        <div className="border-white border-[1px]">
            ...
            <div className="border-white border-[1px]">
                <div className='rounded-[20px] h-[140px] w-[1033px]'>
                    <div className="bg-[#0F0F37] border-[#16163F] rounded-t-[20px] border-[1px] w-[1033px] h-[56px] flex items-center justify-around">
            ...
            <div className='border-white border-[1px]'>
                <div className='text-[#fff] bg-[#16163F] w-[420px] h-[139px] rounded-[20px]'>
            ...
            <div className='border-white border-[1px] w-[1600px]'>
                <div className='text-[#fff] bg-[#16163F] w-[1500px] h-[60px] flex justify-between items-center'>
                    <div className='text-[30px] border-white border-[1px] w-[68px] h-[42px]'>
                        User
                    </div>
